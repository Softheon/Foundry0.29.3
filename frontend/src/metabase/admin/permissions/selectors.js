...
function getTooltipForGroup(group) {
  if (isAdminGroup(group)) {
    ...
    return t`Every Softheon user belongs to the All Users group. If you want to limit or restrict a group's access to something, make sure the All Users group has an equal or lower level of access.`;
