(ns metabase.honeymssql.core
  (:refer-clojure :exclude [group-by format])
  (:require [metabase.honeymssql.format :as format]
            [metabase.honeymssql.types :as types]
            [metabase.honeymssql.helpers :refer [build-clause]]
            #?(:clj [metabase.honeymssql.util :refer [defalias]])
...
(defn build
  ...
  Clauses are defined with the metabase.honeymssql.helpers/build-clause multimethod.
